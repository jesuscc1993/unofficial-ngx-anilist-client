...
/* harmony import */ var _modules_anime_services_anime_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/anime/services/anime.service */ "./src/app/modules/anime/services/anime.service.ts");
/* harmony import */ var _modules_shared_store_auth_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/shared/store/auth.store */ "./src/app/modules/shared/store/auth.store.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authStore, animeService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.authStore
            .getObservable()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (_a) {
            var user = _a.user;
            if (user) {
                _this.animeService.getAnimeList(_this.authStore.getUser()).subscribe();
            }
        }))
            .subscribe();
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_modules_shared_store_auth_store__WEBPACK_IMPORTED_MODULE_3__["AuthStore"], _modules_anime_services_anime_service__WEBPACK_IMPORTED_MODULE_2__["AnimeService"]])
    ], AppComponent);
    return AppComponent;
}());
        ...
        return new Promise(function (resolve) {
            ...
            injector.get(_angular_common__WEBPACK_IMPORTED_MODULE_0__["LOCATION_INITIALIZED"], Promise.resolve(null)).then(function () {
                ...
                translateService
                    ...
                    .subscribe(function () { return resolve(null); });
            });
        });
    };
};
...
/* harmony import */ var _shared_api_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/api/api */ "./src/app/modules/shared/api/api.ts");
/* harmony import */ var _shared_store_auth_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/store/auth.store */ "./src/app/modules/shared/store/auth.store.ts");
/* harmony import */ var _anime_api_queries__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./anime-api.queries */ "./src/app/modules/anime/api/anime/anime-api.queries.ts");
...
var AnimeApi = /** @class */ (function (_super) {
    ...
    AnimeApi.prototype.queryAnimeGenres = function () {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["genresQuery"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) { return _this.getResponseData(response).GenreCollection; }));
    };
    AnimeApi.prototype.queryAnimeFromIds = function (mediaIds) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["mediaSearchQuery"], {
            mediaType: 'ANIME',
            idIn: mediaIds,
            sort: 'TITLE_ROMAJI',
    ...
    AnimeApi.prototype.queryAnimeSearch = function (query, pageInfo) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["mediaIdSearchQuery"], __assign({}, this.getPageOptions(pageInfo), query, { mediaType: 'ANIME', adultContent: query.adultContent || false, sort: query.sort || 'TITLE_ROMAJI' })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) { return _this.getResponseData(response).Page; }));
    };
    AnimeApi.prototype.queryAnimeList = function (user) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["listQuery"], {
            mediaType: 'ANIME',
            userId: user.id,
    ...
    AnimeApi.prototype.queryAnimeListMediaIdsByStatus = function (user) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["listMediaIdsQuery"], {
            mediaType: 'ANIME',
            userId: user.id,
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
    ...
    AnimeApi.prototype.queryRecentlyUpdatedAnime = function (user, pageInfo) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["updatedEntriesQuery"], __assign({}, this.getPageOptions(pageInfo), { mediaType: 'ANIME', userId: user.id, sort: 'UPDATED_TIME_DESC' })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) { return _this.getResponseData(response).Page; }));
    };
    AnimeApi.prototype.queryRecentlyFinishedAiringAnime = function (query, pageInfo) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["finishedAiringMediaQuery"], __assign({}, this.getPageOptions(pageInfo), query, { mediaType: 'ANIME', status: 'FINISHED', sort: 'END_DATE_DESC', onList: true })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) { return _this.getResponseData(response).Page; }));
    };
    AnimeApi.prototype.queryRelatedAnimeMedia = function (user) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["relatedMediaQuery"], {
            mediaType: 'ANIME',
            userId: user.id,
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            var mediaList = [];
    ...
    AnimeApi.prototype.queryFavouriteIdsResultsPage = function (options, favouriteIds, callback) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["listFavouritesQuery"], options)
    ...
    AnimeApi.prototype.saveAnimeListEntry = function (listEntry) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["saveListEntryQuery"], {
    ...
    AnimeApi.prototype.deleteAnimeListEntry = function (listEntry) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["deleteListEntryQuery"], {
            id: listEntry.id,
    ...
    AnimeApi.prototype.toggleAnimeFavouriteEntry = function (listEntry) {
        var _this = this;
        return this.postGraphQlRequest(_anime_api_queries__WEBPACK_IMPORTED_MODULE_5__["toggleFavouriteEntryQuery"], {
    ...
    AnimeApi = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"], _shared_store_auth_store__WEBPACK_IMPORTED_MODULE_4__["AuthStore"]])
    ], AnimeApi);
    return AnimeApi;
...
/* harmony import */ var _domain_media_domain__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../domain/media.domain */ "./src/app/modules/anime/domain/media.domain.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MtAnimeInfoComponent = /** @class */ (function () {
    ...
    MtAnimeInfoComponent.prototype.getFormattedMediaDuration = function (media) {
        return Object(_domain_media_domain__WEBPACK_IMPORTED_MODULE_2__["getFormattedMediaDuration"])(media);
    };
    __decorate([
...
var MtSearchResultsTableComponent = /** @class */ (function () {
    ...
    MtSearchResultsTableComponent.prototype.sortBy = function (sort) {
        this.onSortChange.emit(Object(_domain_media_domain__WEBPACK_IMPORTED_MODULE_2__["getMediaSortFromSort"])(sort));
    };
...
var MtUserAnimeListTableComponent = /** @class */ (function () {
    ...
    MtUserAnimeListTableComponent.prototype.onPageChange = function () {
        _utils_generic_util__WEBPACK_IMPORTED_MODULE_2__["ScrollUtil"].scrollToRef(this.elementRef);
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMediaSortFromSort", function() { return getMediaSortFromSort; });
...
var AnimeService = /** @class */ (function () {
    ...
    AnimeService.prototype.searchAnime = function (query, pageInfo) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (pageData) { return _this.mediaStore.setAnime(pageData.media); }));
    };
    AnimeService.prototype.getAnimeList = function (user) {
        ...
        return this.animeApi.queryAnimeList(user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (listEntriesDictionary) {
            return _this.mediaStore.setAnime(Object.keys(listEntriesDictionary)
    ...
    AnimeService.prototype.getRecentlyUpdatedAnime = function (user, pageInfo) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (pageData) { return _this.mediaStore.setAnime(pageData.mediaList.map(function (listEntry) { return listEntry.media; })); }));
    };
    ...
    AnimeService.prototype.getRelatedAnimeMedia = function (user) {
        var _this = this;
        return this.animeApi.queryRelatedAnimeMedia(user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (mediaList) { return _this.mediaStore.setAnime(mediaList); }));
    };
...
var MtHeaderComponent = /** @class */ (function (_super) {
    ...
    function MtHeaderComponent(router, authService, authStore) {
        ...
        if (location.href.includes(_app_constants__WEBPACK_IMPORTED_MODULE_4__["apiTokenPrefix"])) {
        ...
        _this.router.events
            ...
            _this.onRoot = location.href.includes(_app_constants__WEBPACK_IMPORTED_MODULE_4__["rootUrl"]);
            _this.onDashboard = location.href.includes(_app_constants__WEBPACK_IMPORTED_MODULE_4__["dashboardUrl"]);
            _this.onAnimeSearch = location.href.includes(_app_constants__WEBPACK_IMPORTED_MODULE_4__["animeSearchUrl"]);
            _this.onUserList = location.href.includes(_app_constants__WEBPACK_IMPORTED_MODULE_4__["userListUrl"]);
        }))
            .subscribe();
        _this.authService.userChange
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/app/modules/shared/store/store.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var MediaStore = /** @class */ (function (_super) {
    ...
    function MediaStore() {
        return _super.call(this, { animeDictionary: {} }) || this;
    }
    MediaStore.prototype.setAnime = function (animeList) {
        this.setState({
            animeDictionary: __assign({}, animeList.reduce(function (animeDictionary, anime) {
                var _a;
...
/***/ "./src/app/modules/shared/store/store.ts":
/*!***********************************************!*\
  !*** ./src/app/modules/shared/store/store.ts ***!
  \***********************************************/
...
var Store = /** @class */ (function () {
    function Store(initialState) {
        ...
        this.subject = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"](initialState);
    }
    ...
    Store.prototype.getObservable = function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mediaFormats", function() { return mediaFormats; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mediaStatuses", function() { return mediaStatuses; });
...
var mediaFormats = ['MOVIE', 'MUSIC', 'ONA', 'OVA', 'SPECIAL', 'TV_SHORT', 'TV'];
var mediaStatuses = ['FINISHED', 'RELEASING', 'NOT_YET_RELEASED', 'CANCELLED'];
...
/* harmony import */ var _modules_anime_domain_media_domain__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../modules/anime/domain/media.domain */ "./src/app/modules/anime/domain/media.domain.ts");
...
/* harmony import */ var _modules_shared_types_anilist_media_types__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../modules/shared/types/anilist/media.types */ "./src/app/modules/shared/types/anilist/media.types.ts");
/* harmony import */ var _utils_generic_util__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../utils/generic.util */ "./src/app/utils/generic.util.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var AnimeSearchPageComponent = /** @class */ (function (_super) {
    ...
    function AnimeSearchPageComponent(router, activatedRoute, titleService, translateService, animeService, authService, authStore, formBuilder) {
        ...
        _this.mediaFormats = _modules_shared_types_anilist_media_types__WEBPACK_IMPORTED_MODULE_15__["mediaFormats"];
        _this.mediaStatuses = _modules_shared_types_anilist_media_types__WEBPACK_IMPORTED_MODULE_15__["mediaStatuses"];
    ...
    AnimeSearchPageComponent.prototype.search = function (pageIndex, perPage) {
        ...
        if (this.resultsTable) {
            _utils_generic_util__WEBPACK_IMPORTED_MODULE_16__["ScrollUtil"].scrollToRef(this.resultsTable);
        }
        this.searching = true;
        this.error = undefined;
        var filters = this.searchForm.value;
        var query = __assign({}, filters, { startDateSmallerThan: filters.startDateSmallerThan && Object(_modules_anime_domain_media_domain__WEBPACK_IMPORTED_MODULE_9__["getDateScalarFromYear"])(filters.startDateSmallerThan), startDateGreaterThan: filters.startDateGreaterThan && Object(_modules_anime_domain_media_domain__WEBPACK_IMPORTED_MODULE_9__["getDateScalarFromYear"])(filters.startDateGreaterThan), averageScoreGreaterThan: filters.averageScoreGreaterThan && filters.averageScoreGreaterThan * 10, averageScoreSmallerThan: filters.averageScoreSmallerThan && filters.averageScoreSmallerThan * 10, sort: this.sort });
        this.animeService
            .searchAnime(query, {
            pageIndex: pageIndex,
            perPage: perPage,
    ...
    AnimeSearchPageComponent.prototype.isSet = function (variable) {
...
/* harmony import */ var _utils_generic_util__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../utils/generic.util */ "./src/app/utils/generic.util.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserAnimeListPageComponent = /** @class */ (function () {
    ...
    UserAnimeListPageComponent.prototype.scrollToStatus = function (status) {
        _utils_generic_util__WEBPACK_IMPORTED_MODULE_9__["ScrollUtil"].scrollIntoView(document.getElementById(status));
    };
...
var ScrollUtil = /** @class */ (function () {
    ...
    ScrollUtil.scrollIntoView = function (element) {
        element.scrollIntoView({ block: 'start', behavior: 'smooth' });
    };
    ScrollUtil.scrollToRef = function (elementRef) {
...
module.exports = __webpack_require__(/*! Z:\Txus\Projects\web\unofficial-ng5-anilist-client\src\main.ts */"./src/main.ts");
